...
__all__ = ["NullUndo", "UndoInfo", "Journal", "UndoRedo", "UndoList",
           "UndoError", "FakeUndoInfo"]

import logging
logger = logging.getLogger('nvlib.undo')
...
class UndoInfo:
    ...
    def check_info(self):
        ...
        @raise UndoError: if the UndoInfo contains the reserved keyword 'undolist'
        """
