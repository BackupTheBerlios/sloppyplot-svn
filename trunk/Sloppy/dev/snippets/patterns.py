...
What it does: Identify a pattern (=a list of x-values with
corresponding relative intensities) from a list of x/y values.
...
def match_pattern(datax, datay, patterns, xerr=0.2, yerr=0.2):    
