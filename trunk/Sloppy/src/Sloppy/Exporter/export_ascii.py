...
# $HeadURL: file:///home/nv/sloppysvn/trunk/Sloppy/src/Sloppy/Exporter/export_ascii.py $
# $Id: export_ascii.py 430 2005-08-03 20:07:56Z nv $
...
class Exporter(dataio.Exporter):
    ...
    delimiter = Prop(types=basestring, default='\t')
...
#------------------------------------------------------------------------------
dataio.ExporterRegistry.register("ASCII", Exporter)
