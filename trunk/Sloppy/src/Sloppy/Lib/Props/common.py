...
__all__ = ["Integer", "Float", "Keyword", "String", "Boolean", "Unicode",
           "Range", "IntegerRange", "FloatRange",
           "Instance", "List", "Dictionary"]
...
class Range(VP):
    def __init__(self,
                 type_validator=VInteger(),
                 min=None, max=None, default=Undefined, **kwargs):
        ...
        VP.__init__(self, RequireAll(type_validator, VRange(min,max)),
